import type { Fn, MaybeRefOrGetter, Stoppable } from '../../../types';
import { toValue } from '../../shared';
import { until } from '../../watch';
...
import type { EventHookOn } from '../../utilities';
import { createEventHook } from '../../utilities';
import { containsProp } from '../../../utils';
...
export function useFetch<T>(
  ...
  const { fetch = _window?.fetch, initialData, timeout } = options;
